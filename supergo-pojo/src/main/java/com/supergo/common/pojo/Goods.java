...
@Table(name = "tb_goods")
@ApiModel(value = "goods对象", description = "goods实体类")
public class Goods implements Serializable {
    ...
    @ApiModelProperty(value = "SPU名", name = "goodsName", dataType = "String")
    ...
    @ApiModelProperty(value = "默认SKU", name = "defaultItemId", dataType = "Long")
    ...
    @ApiModelProperty(value = "状态", name = "auditStatus", dataType = "String")
    ...
    @ApiModelProperty(value = "是否上架", name = "isMarketable", dataType = "String")
    ...
    @ApiModelProperty(value = "品牌", name = "brandId", dataType = "Long")
     ...
     */
    @Column(name = "caption")
    @ApiModelProperty(value = "副标题", name = "caption", dataType = "String")
    ...
    @ApiModelProperty(value = "一级类目", name = "category1Id", dataType = "Long")
    ...
    @ApiModelProperty(value = "二级类目", name = "category2Id", dataType = "Long")
    ...
    @ApiModelProperty(value = "三级类目", name = "category3Id", dataType = "Long")
    ...
    @ApiModelProperty(value = "小图", name = "smallPic", dataType = "String")
     ...
     */
    @Column(name = "price")
    @ApiModelProperty(value = "商城价", name = "price", dataType = "Double")
    ...
    @ApiModelProperty(value = "分类模板ID", name = "typeTemplateId", dataType = "Long")
    ...
    @ApiModelProperty(value = "是否启用规格", name = "isEnableSpec", dataType = "String")
    ...
    @ApiModelProperty(value = "是否删除", name = "isDelete", dataType = "String")
