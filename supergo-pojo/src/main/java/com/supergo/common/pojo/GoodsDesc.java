...
@ApiModel(value = "goodsDesc对象", description = "商品规格实体类")
public class GoodsDesc implements Serializable {
    ...
    @ApiModelProperty(value = "SPU_ID", name = "goodsId", required = true, dataType = "Long")
    ...
    @ApiModelProperty(value = "规格结果集，所有规格，包含isSelected", name = "specificationItems", dataType = "String")
    ...
    @ApiModelProperty(value = "自定义属性（参数结果）", name = "CustomAttrItems", dataType = "String")
    private String customAttributeItems;


    @Column(name = "item_images")
    @ApiModelProperty(value = "itemImages", name = "itemImages", dataType = "String")
    ...
    @ApiModelProperty(value = "包装列表", name = "packageList", dataType = "String")
    ...
    @ApiModelProperty(value = "售后服务", name = "saleService", dataType = "String")
