...
public class ElasticsearchConfig {
    ...
    private String esCluster = "192.168.21.185:9301,192.168.21.185:9302,192.168.21.185:9303";
    ...
    public Client client_single() {
        ...
        try {
            ...
            client.addTransportAddress(new TransportAddress(InetAddress.getByName("192.168.71.211"), 9300));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return client;
