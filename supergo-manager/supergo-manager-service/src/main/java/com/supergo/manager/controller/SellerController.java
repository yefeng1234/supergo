...
public class SellerController {
    ...
    */
    ...
    @ApiOperation(value = "根据id查询商家", notes = "商家id")
    ...
    */
    @RequestMapping("/add")
    @ApiOperation(value = "增加商家", notes = "商家对象")
    ...
    */
    ...
    @ApiOperation(value = "修改商家", notes = "商家对象")
    ...
    */
    ...
    @ApiOperation(value = "根据id删除商家", notes = "接受对象参数ids")
    ...
    */
     ...
     * @Time 17:22
    */
    @ApiOperation(value = "获取商家状态", notes = "商家id及状态信息")
