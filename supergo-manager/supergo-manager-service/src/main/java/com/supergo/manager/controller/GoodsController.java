...
public class GoodsController {
    ...
    */
     ...
     * @Time 16:52
    */
    @ApiOperation(value = "产品分类分页查询",notes = "接受分页参数page,rows")
     ...
     * @Time 16:53
    */
    @ApiOperation(value = "产品分类管理之新建",notes = "接受对象参数itemCat")
    ...
    */
     ...
     * @Time 16:53
    */
    @ApiOperation(value = "产品管理之修改回显",notes = "接受对象参数Id")
    ...
    */
     ...
     * @Time 16:54
    */
    @ApiOperation(value = "根据关键子模糊查询产品数据",notes = "接受对象参数goods")
